...
namespace Micro_Social_Platform.Data.Migrations
{
    ...
    [Migration("20240110133035_Follow")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Micro_Social_Platform.Models.FollowRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Micro_Social_Platform.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Micro_Social_Platform.Models.Post", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Micro_Social_Platform.Models.Comment", b =>
                {
                    b.HasOne("Micro_Social_Platform.Models.Post", "Post")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Micro_Social_Platform.Models.FollowRequest", b =>
                {
                    b.HasOne("Micro_Social_Platform.Models.ApplicationUser", "Receiver")
                        .WithMany("ReceivedFollowRequests")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Micro_Social_Platform.Models.ApplicationUser", "Sender")
